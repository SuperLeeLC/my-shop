...
<%--                                        <input type="email" class="form-control" id="email" placeholder="请输入邮箱地址" />--%>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input cssClass="form-control required mobile" path="username" placeholder="请输入用户的姓名"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input cssClass="form-control required" path="phone" placeholder="请输入用户的手机号"/>
                                    </div>
                                </div>
